...
import { ToastrModule, ToastrService, GlobalConfig } from 'ngx-toastr';
...
import { LoaderComponent } from './modules/general/loader/main';
...
@NgModule({
  ...
  providers: [Service_worker, CurrencyPipe, DatePipe, ApiService, ToastrService,{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }],
